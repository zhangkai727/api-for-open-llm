...
llm = OpenAI(
    ...
    temperature=0,  # 温度设置为 0（控制生成文本的随机性）
    openai_api_base="http://192.168.0.53:7891/v1",  # OpenAI API 的基础 URL
    openai_api_key="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",  # OpenAI API 的访问密钥
)



# 插件信息的文本模板，用于拼接插件的关键信息
